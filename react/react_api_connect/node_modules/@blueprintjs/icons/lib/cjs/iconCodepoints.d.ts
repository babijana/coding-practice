...
export declare const IconCodepoints: {
    ...
    blank: string;
    "block-promote": string;
    "blocked-person": string;
    bold: string;
    book: string;
    bookmark: string;
    box: string;
    "branch-locked": string;
    "branch-unlocked": string;
    briefcase: string;
    "bring-data": string;
    ...
    "filter-sort-asc": string;
    "filter-sort-desc": string;
    filter: string;
    flag: string;
    flame: string;
    flash: string;
